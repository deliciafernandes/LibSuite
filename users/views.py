...
# 	#if else case to check if the form filled is a valid POST request or no
#     if request.method == 'POST':
...
#             #LET'S GIVE THE USER A FEEDBACK THAT THE PROFILE IS UPDATED
...
# 	previous_page = request.META.get('HTTP_REFERER')
# 	return render(request, 'users/bookbank.html',{'previous_page' : previous_page})
